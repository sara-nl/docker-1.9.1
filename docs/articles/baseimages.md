...
GitHub Repo:
 ...
 - [BusyBox](https://github.com/sara-nl/docker-1.9.1/blob/master/contrib/mkimage-busybox.sh)
 - CentOS / Scientific Linux CERN (SLC) [on Debian/Ubuntu](
   https://github.com/sara-nl/docker-1.9.1/blob/master/contrib/mkimage-rinse.sh) or
   [on CentOS/RHEL/SLC/etc.](
   https://github.com/sara-nl/docker-1.9.1/blob/master/contrib/mkimage-yum.sh)
 - [Debian / Ubuntu](
   https://github.com/sara-nl/docker-1.9.1/blob/master/contrib/mkimage-debootstrap.sh)
