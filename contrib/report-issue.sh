...
# template of information. See https://github.com/sara-nl/docker-1.9.1/pull/8845

set -e

DOCKER_ISSUE_URL=${DOCKER_ISSUE_URL:-"https://github.com/sara-nl/docker-1.9.1/issues/new"}
